...
const es: Dictionary = {
  ...
  timeline: {
    ...
    entries: {
      ...
      'recognition-guardianes': { period: 'Mayo 2026',
        ...
        description: 'Reconocimiento oficial por la contribución al proyecto Guardianes del Humedal mediante la integración de sistemas funcionales desarrollados en El Viaje de Franklin.',
      },
    },
  },
  ...
  projects: {
    ...
    entries: {
      'forsaken-rules': { imageAlt: 'Captura de Forsaken Rules — pendiente de añadir',
        name: 'Forsaken Rules',
      ...
      'eden-404': { imageAlt: 'Captura de Eden 404 — pendiente de añadir',
        name: 'Eden 404',
      ...
      'franklins-journey': { imageAlt: 'Captura de El Viaje de Franklin — pendiente de añadir',
  ...
  certificates: {
    ...
    lead: 'Reconocimientos y credenciales relacionados con proyectos de desarrollo de videojuegos.',
    ...
    entries: {
      'tourism-care-contribution': {
        ...
        description: 'Reconocimiento por la contribución al proyecto Guardianes del Humedal, integrando sistemas funcionales desarrollados en El Viaje de Franklin dentro de un entorno virtual educativo.',
      },
    },
  },
