...
const fr: Dictionary = {
  meta: { title: 'Joaquin Salinas | Portfolio', description: 'Portfolio de Joaquin Salinas : projets Unity et C#, technical game design, technical QA et gameplay programming.' },
  ...
  hero: { badge: 'Game Dev · Technical Design · QA', namePlaceholder: 'Joaquin Augusto Salinas Tuesta', role: 'Technical Game Designer · Technical QA · Gameplay Programmer', intro: 'Étudiant en Game Design avec une expérience pratique sur des projets Unity en C#. J’ai travaillé sur des systèmes de gameplay, le design technique, l’optimisation des performances et le QA technique, en combinant implémentation, playtesting et debugging.', tags: ['Unity + C#', 'Gameplay Systems', 'Technical QA', 'Git/GitHub'], specializationsAria: 'Domaines de spécialisation', aspiration: 'Mon profil est principalement orienté vers le Technical Game Design et le Technical QA, complété par une expérience en Gameplay Programming.', ctaProjects: 'Voir les projets', ctaCv: 'Télécharger le Resume', ctaCvAria: 'Télécharger le Resume en PDF', ctaContact: 'Contact', profileAvailable: 'Disponible', profileAlt: 'Photo professionnelle de Joaquin Augusto Salinas Tuesta' },
  ...
  projects: { badge: 'Projets', title: 'Projets', lead: 'Projets académiques sur lesquels j’ai principalement travaillé en design technique, QA, optimisation et gameplay programming avec Unity, C# et Git/GitHub.', filtersAria: 'Filtrer les projets par plateforme', filters: { all: 'Tous', pc: 'PC', mobile: 'Mobile', console: 'Console', multiplatform: 'Multiplateforme' }, emptyMessage: 'Aucun projet ne correspond à ce filtre.', listAria: 'Liste des projets', roleLabel: 'Rôle', engineLabel: 'Moteur', techListAria: 'Technologies et domaines', placeholderTag: 'Contenu à confirmer', githubAction: 'GitHub', githubAria: (project) => `Dépôt GitHub de ${project}`, youtubeAction: 'Voir la vidéo', youtubeAria: (project) => `Voir la vidéo de ${project} sur YouTube`, downloadAction: 'Télécharger', downloadAria: (project) => `Télécharger ${project}`, storeAria: (project, store) => `${project} sur ${store}`, statusLabels: { completed: 'Terminé', 'in-development': 'En développement', prototype: 'Prototype', 'game-jam': 'Game Jam' }, platformLabels: { pc: 'PC', mobile: 'Mobile', console: 'Console', web: 'Web' }, platformSoloPrefix: 'Seulement', platformMultiLabel: 'Multiplateforme', platformUnknownLabel: 'À confirmer', entries: { 'forsaken-rules': { imageAlt: 'Visuel promotionnel de Forsaken Rules avec le logo et les personnages principaux', name: 'Forsaken Rules', shortDescription: 'Roguelike isométrique 3D publié sur Steam. Développement de systèmes de gameplay et mécaniques en Unity/C#, architecture modulaire, playtesting technique et optimisation.', role: 'Gameplay Programmer / Technical Game Designer' }, 'eden-404': { imageAlt: 'Image promotionnelle de Eden 404 avec le personnage principal et le logo du projet', name: 'Eden 404', shortDescription: 'FPS 3D : implémentation de mécaniques de gameplay et de systèmes d’interaction, résolution de problèmes de stabilité et de performance, optimisation de systèmes procéduraux.', role: 'Gameplay Programmer / Technical Designer' }, 'franklins-journey': { imageAlt: "Écran titre de Franklin's Journey", name: "Franklin's Journey", shortDescription: 'Bullet Hell 2D pour Android. Développement d’un système efficace de projectiles, optimisation mobile et validation fonctionnelle.', role: 'Gameplay Programmer' } } },
  ...
  certificates: {
    badge: 'Certificats',
    title: 'Certificats et reconnaissance',
    lead: 'Reconnaissances et certifications liées à la formation, aux langues et aux projets.',
    categoryLabels: { local: 'Reconnaissances locales', global: 'Certifications globales' },
    syncingText: 'Dossier à compléter',
    doneText: 'Aucune certification dans cette catégorie pour le moment.',
    verifyAction: 'Voir le certificat',
    verifyAria: (name) => `Ouvrir le certificat : ${name}`,
    statusLabels: { active: 'Délivré', expired: 'Expiré', 'in-progress': 'En cours' },
    entries: {
      'tourism-care-contribution': { name: 'Certificat de contribution', issuer: 'Asociación Civil Turismo Cuida', description: 'Reconnaissance pour la contribution au projet Guardianes del Humedal.' },
      'office-domain-romero': { name: 'Maîtrise d’Office', issuer: 'Fundación Romero · Becas Grupo Romero', description: 'Cours terminé avec succès, d’une durée de 80 heures académiques.' },
      'advanced-english-british-center': { name: 'Anglais avancé', issuer: 'El Centro Británico · Ucayali', description: 'Certificat de formation en anglais avancé d’une durée de 440 heures.' },
      'ef-set-c1-advanced': { name: 'EF SET English Certificate — C1 Advanced', issuer: 'EF SET', description: 'Score de 69/100, correspondant au niveau C1 Advanced du CECR.' },
    },
  },
  ...
  footer: { namePlaceholder: 'Joaquin Augusto Salinas Tuesta', role: 'Technical Game Designer · Technical QA · Gameplay Programmer', lastUpdateLabel: 'Dernière mise à jour', systemStatusLabel: 'SYSTEM STATUS', onlineLabel: 'ONLINE', backToTopAria: 'Retour en haut' },
};
