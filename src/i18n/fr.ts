...
const fr: Dictionary = {
  meta: { title: 'Joaquin Salinas | Portfolio', description: 'Portfolio de Joaquin Salinas : projets Unity et C#, gameplay programming, technical game design et technical QA.' },
