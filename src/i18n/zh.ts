...
const zh: Dictionary = {
  meta: { title: 'Joaquin Salinas | Portfolio', description: 'Joaquin Salinas 的作品集：Unity 与 C# 项目、Technical Game Design、Technical QA 和 Gameplay Programming。' },
  ...
  footer: { namePlaceholder: 'Joaquin Augusto Salinas Tuesta', role: 'Technical Game Designer · Technical QA · Gameplay Programmer', lastUpdateLabel: '最后更新', systemStatusLabel: 'SYSTEM STATUS', onlineLabel: 'ONLINE', backToTopAria: '返回顶部' },
};
