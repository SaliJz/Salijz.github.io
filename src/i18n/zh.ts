...
const zh: Dictionary = {
  meta: { title: 'Joaquin Salinas — Technical Game Designer | Gameplay Programmer | Technical QA', description: 'Joaquin Salinas 的作品集：Unity 与 C# 项目、Gameplay Programming、Technical Game Design 和 Technical QA。' },
  ...
  certificates: { badge: '证书', title: '证书与认可', lead: '与游戏开发项目相关的证书和认可。', categoryLabels: { local: '本地认可', global: '全球证书' }, syncingText: '记录待补充', doneText: '此类别暂无其他证书。', verifyAction: '验证', verifyAria: (name) => `验证证书：${name}`, statusLabels: { active: '已颁发', expired: '已过期', 'in-progress': '进行中' }, entries: { 'tourism-care-contribution': { name: '贡献证书', issuer: 'Asociación Civil Turismo Cuida', description: '因向教育项目 Guardianes del Humedal 提供功能性 gameplay 系统而获得认可。' } } },
